...
<div class="row">
    <div class="form-group col-md-6">
        ...
        <input type="text" name="dt_adimissao" pattern="(0[1-9]|1[0-9]|2[0-9]|3[01]).(0[1-9]|1[012]).[0-9]{4}" value="{{ $funcionario->dt_adimissao }}" class="form-control date-mask" id="dataAdmFunc" required>
    </div>
    <div class="form-group col-md-6">
        <label for="dataDemFunc">Data de Demissão</label>
        <input type="text" name="dt_demissao" pattern="(0[1-9]|1[0-9]|2[0-9]|3[01]).(0[1-9]|1[012]).[0-9]{4}" value="{{ $funcionario->dt_demissao }}" class="form-control date-mask" id="dataDemFunc">
    </div>
</div>
